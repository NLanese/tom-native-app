    ...
    return (
        <View>
            ...
            <Toggle checked={immediateCheck} onChange={onImmediateMedicalChange} />
                ...
                {injuryData.contact_info.firstname !== null && injuryData.contact_info.lastname !== null && injuryData.contact_info.phone_number !== null && injuryData.contact_info.address !== null ? (<ContinueButton nextPage={'collision-injury-report-extra-info'} buttonText={'Continue'} pageName={'collision-injury-report-information-continue-button'}/>) : null}
        </View>
    )
}
